...
with open(csv_path, mode="w", newline="") as file:
    ...
    writer.writerow(["ID Type", "Name", "DOB", "Gender", "Number", "Face Image Path"])
    writer.writerow([id_type, name, dob, gender, number, face_path])

print(f"✅ Extracted details saved to: {csv_path}")